...
bc.seeAllByParent = {
  init: function () {
    ...
    $form.delegate(".bc-cert-showAllGroups", "click", function () {
      ...
      $(this).closest(".bc-page").find(".bc-cert-Groups").each(function () {
        $(this).show('fast')
      });
      $(this).closest(".bc-page").find(".bc-cert-showGroups").each(function () {
        $(this).hide()
      });
      $(this).closest(".bc-page").find(".bc-cert-hiddenGroups").each(function () {
        $(this).show()
      });
    });
    //绑定隐藏全部事件
